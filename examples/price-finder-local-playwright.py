"""
Price Finder using Local Playwright: A LangGraph workflow that uses a local Playwright instance
instead of Scrapybara for web-based price lookups.
"""
...
# Create the Computer Use Agent (CUA) graph with local Playwright
cua_graph = create_cua(
    environment="web",
    use_local_playwright=True,  # Use local Playwright instead of Scrapybara
    headless=False,  # Set to True to run without visible browser
    browser_type="chromium",  # Can also use "firefox" or "webkit"
)
...
graph.name = "Price Finder with Local Playwright"
